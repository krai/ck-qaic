...
RUN_CMD_COMMON_SUFFIX="${RUN_CMD_COMMON_SUFFIX_DEFAULT} ${RUN_CMD_COMMON_SUFFIX} $DEVICE_IDS_OVERRIDE $POWER_YES"
...
RUN_CMD_PREFIX="$RUN_CMD_PREFIX_BERT999 $CMD_QUOTE"
RUN_CMD_SUFFIX="$RUN_CMD_COMMON_SUFFIX $RUN_CMD_SUFFIX_BERT999 $CMD_QUOTE"
