...
BERT99_OFFLINE_TARGET_QPS=2700
BERT99_SERVER_TARGET_QPS=2500

# BERT-99.9% (FP16 precision).
BERT999_OFFLINE_OVERRIDE_BATCH_SIZE=4096
BERT999_SERVER_OVERRIDE_BATCH_SIZE=1024
BERT999_OFFLINE_TARGET_QPS=1400
BERT999_SERVER_TARGET_QPS=1250

# ResNet50.
RESNET50_OFFLINE_TARGET_QPS=85000
RESNET50_SERVER_TARGET_QPS=82500
