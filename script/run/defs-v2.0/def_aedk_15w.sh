...
BERT99_MULTISTREAM_TARGET_LATENCY=57
BERT99_OFFLINE_TARGET_QPS=185
...
RESNET50_OFFLINE_TARGET_QPS=6000

# SSD-ResNet34.
SSD_RESNET34_SINGLESTREAM_TARGET_LATENCY=24
SSD_RESNET34_MULTISTREAM_TARGET_LATENCY=107
SSD_RESNET34_OFFLINE_TARGET_QPS=125

# SSD-MobileNet-v1.
SSD_MOBILENET_SINGLESTREAM_TARGET_LATENCY=1.8
SSD_MOBILENET_MULTISTREAM_TARGET_LATENCY=4.5
SSD_MOBILENET_OFFLINE_TARGET_QPS=3400
