...
--sut=r282_z93_q5 --library=qaic-v1.3.14-a100 --model=ssd_resnet34 --scenario=server \
...
<pre>
<b>[anton@ax530b-03-giga ~]&dollar;</b> time ck run cmdgen:benchmark.object-detection.qaic-loadgen --verbose \
--sut=aedk.8nsp --library=qaic-v1.3.14-a100 --model=ssd_resnet34 --scenario=server \
