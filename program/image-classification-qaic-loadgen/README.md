...
<pre>
<b>[anton@ax530b-03-giga ~]&dollar;</b> ck install package --tags=model,tf,mlperf,resnet50,fix_input_shape
</pre>
...
<pre>
<b>[anton@ax530b-03-giga ~]&dollar;</b> echo "precalibrated" | ck detect soft --tags=compiler,glow,profile \
...
<b>[anton@ax530b-03-giga ~]&dollar;</b> ck install package \
--dep_add_tags.profile-resnet50=mlperf.option1 \
--tags=model,qaic,resnet50,resnet50.aedk.8nsp.offline

<b>[anton@ax530b-03-giga ~]&dollar;</b> ck install package --tags=install-to-aedk \
--dep_add_tags.model-qaic=resnet50,resnet50.aedk.8nsp.offline \
...
<b>[anton@ax530b-03-giga ~]&dollar;</b> ck install package \
--dep_add_tags.profile-resnet50=mlperf.option1 \
--tags=model,qaic,resnet50,resnet50.aedk.8nsp.singlestream

<b>[anton@ax530b-03-giga ~]&dollar;</b> ck install package --tags=install-to-aedk \
--dep_add_tags.model-qaic=resnet50,resnet50.aedk.8nsp.singlestream \
--env.CK_AEDK_IPS="aedk1 aedk2" --env.CK_AEDK_PORTS="3231 3232" --env.CK_AEDK_USER=$USER
</pre>
...
<b>[anton@ax530b-03-giga ~]&dollar;</b> ck install package \
--dep_add_tags.profile-resnet50=mlperf.option1 \
--tags=model,qaic,resnet50,resnet50.aedk.16nsp.offline

<b>[anton@ax530b-03-giga ~]&dollar;</b> ck install package --tags=install-to-aedk \
--dep_add_tags.model-qaic=resnet50,resnet50.aedk.16nsp.offline \
...
<b>[anton@ax530b-03-giga ~]&dollar;</b> ck install package \
--dep_add_tags.profile-resnet50=mlperf.option1 \
--tags=model,qaic,resnet50,resnet50.aedk.16nsp.singlestream

<b>[anton@ax530b-03-giga ~]&dollar;</b> ck install package --tags=install-to-aedk \
--dep_add_tags.model-qaic=resnet50,resnet50.aedk.16nsp.singlestream \
--env.CK_AEDK_IPS="aedk3" --env.CK_AEDK_PORTS="3233" --env.CK_AEDK_USER=$USER
</pre>
