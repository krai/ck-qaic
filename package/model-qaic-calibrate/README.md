...
Apply this [patch](https://raw.githubusercontent.com/krai/ck-mlperf/master/package/mlperf-inference-source/patch.linux/aimet_patch) to make the inference code work with the mlperf calibration dataset.

	cd inference
	wget https://raw.githubusercontent.com/krai/ck-mlperf/master/package/mlperf-inference-source/patch.linux/aimet_patch
	git apply aimet_patch
	cd ../
...
The base model used in our experiments can be downloaded  [here](https://zenodo.org/record/3236545/files/resnet34-ssd1200.pytorch). The outputs are saved as "ssd_resnet34_aimet.[onnx|pth|encodings|encodings.yaml]" to a timestamped directory under the "outputs" directory. 
