...
Apply the patch to the inference repo to  let it preprocess the calibration dataset
...
The outputs are saved as "ssd_resnet34_aimet.[onnx|pth|encodings|encodings.yaml]" under the "output" directory. 
